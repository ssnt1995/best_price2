...
public class Compare_bikes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first_spinner = (Spinner) findViewById(R.id.first_bike_spinner);
        second_spinner = (Spinner) findViewById(R.id.second_bike_spinner);
    ...
    public void get_data()
    {
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+IpAddress.ip+"/get_all_products.php", job, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> dataadapter = new ArrayAdapter<String>(Compare_bikes.this , android.R.layout.simple_spinner_dropdown_item,list);
        ...
        AppController app = new AppController(Compare_bikes.this);
